...
// این میاد یک نمونه میسازه
// Instance

// بجای اینکه هربار از اکسیوس اصلی استفاده کنیم یک نمونه مشخص میسازیم و ازش استفاده می کنیم
// که تنظیمات دلخواه خودمون رو می تونه داشته باشه

// وقتی اکسیوس کریت می زنیم
// اکسیوس میاد یک شی جدید میسازه
// که تمام متدها ی پست گت و غیره رو داره

// درواقع اپ هم یک اکسیوس هست ولی با تنظیمات اختصاصی

// مثلا با اکسیوس اصلی ما یک درخواست گت داشته باشیم
// باید کردنشیال ترو اضافه کنیم

// حالا یک درخواست دیگه داشته باشیم باز دوباره باید کردنشیال رو داشته باشم

//  و هر بارم باید ای پی ای  یا همون ادرس بکند رو بهش بدیم

// با این روش کردنشیال روی تمام درخواست های ما ست میشه  ادرس بکند ست میشه و  از تکرار جلوگیری مشه 
